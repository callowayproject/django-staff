...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaffMember.photo_height'
        db.add_column('staff_staffmember', 'photo_height', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'StaffMember.photo_width'
        db.add_column('staff_staffmember', 'photo_width', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'StaffMember.twitter'
        db.add_column('staff_staffmember', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'StaffMember.website'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StaffMember.photo_height'
        db.delete_column('staff_staffmember', 'photo_height')

        # Deleting field 'StaffMember.photo_width'
        db.delete_column('staff_staffmember', 'photo_width')

        # Deleting field 'StaffMember.twitter'
        db.delete_column('staff_staffmember', 'twitter')

        # Deleting field 'StaffMember.website'
        db.delete_column('staff_staffmember', 'website')
