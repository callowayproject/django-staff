...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('staff_staffmember', 'facebook', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'StaffMember.google_plus'
        db.add_column('staff_staffmember', 'google_plus', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Changing field 'StaffMember.photo'
        db.alter_column('staff_staffmember', 'photo', self.gf('staff.fields.RemovableFileField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting field 'StaffMember.facebook'
        db.delete_column('staff_staffmember', 'facebook')

        # Deleting field 'StaffMember.google_plus'
        db.delete_column('staff_staffmember', 'google_plus')
